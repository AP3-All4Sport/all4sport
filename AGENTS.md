...
- La route `/react` dans `backend_symfony/src/Controller/FrontController.php` rend `backend_symfony/templates/front/index.html.twig`.
...
Pour vérifier l'intégration dans le navigateur, utiliser `http://127.0.0.1:8000/react` avec Symfony et Vite démarrés. La configuration actuelle de Vite autorise cette origine et utilise le port `5173`.
